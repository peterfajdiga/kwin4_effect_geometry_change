...
class GeometryChangeEffect {
  ...
  loadConfig() {
    const time = effect.readConfig('AnimationTime', 300)
    this.duration = animationTime(time)
  }
  ...
  onWindowStartUserMovedResized(_window) {
    this.userResizing = true
  }

  onWindowFinishUserMovedResized(_window) {
